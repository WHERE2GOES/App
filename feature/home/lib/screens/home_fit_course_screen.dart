...
class _HomeFitCourseScreenState extends State<HomeFitCourseScreen> {
  ...
  GestureDetector _buildCourseCard({
          ...
          children: [
            Container(
              decoration: BoxDecoration(
                ...
                border: Border.all(color: ThemeColors.grey800, width: 0.35),
              ),
